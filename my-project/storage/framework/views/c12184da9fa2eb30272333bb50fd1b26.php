    ...
    <div class="container-fluid">
      ...
      <div class="navbar-items-container">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 navbar-items">
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('./')); ?>">User Zone</a>
          </li>
          <li class="nav-item">
          <a class="nav-link" href="<?php echo e(url('./admin')); ?>">Admin Area</a>
          </li>
        ...
        <div class="col-lg-6 col-md-11 col-sm-11 mt-4 mx-5 justify-content-end">
          <div class="row d-flex justify-content-end">
            ...
            <div class="info-general border border-2" id="frame">
              <?php if(isset($data)): ?>
    <img class="img-fluid d-block mx-auto" src=" data:image/jpeg;base64,<?php echo e($data); ?>" alt="..." />
    <?php endif; ?>
            </div>
...
</html><?php /**PATH /app/resources/views/index.blade.php ENDPATH**/ ?>